...
import shop1 from '../../../images/shop/shop-1.png'
import shop2 from '../../../images/shop/shop-2.png'
import shop3 from '../../../images/shop/shop-3.png'
import shop4 from '../../../images/shop/shop-4.png'
import shop5 from '../../../images/shop/shop-5.png'

const GroceryShop = () => {
    return (
        <section className="pt-0">
            <h2 className="text-center">Grocery Shop</h2>
